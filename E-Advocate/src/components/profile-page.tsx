...
import { ArrowLeft, Camera, FilePen, Info, UserCircle, Shield, Briefcase, Settings, Star, Search, Users, Ticket, HelpCircle, BookOpen, Award, ChevronRight } from "lucide-react";
      ...
      <main className="flex-1 p-4 md:p-6">
        ...
        <div className="space-y-4">
          {profileSections.map((section, index) => (
            <Card key={index} className="p-4 flex items-center gap-4 cursor-pointer hover:bg-muted">
