...
export function FeaturedProfilesPage() {
  const router = useRouter();
      ...
      <div className="flex flex-col min-h-screen bg-background text-foreground pb-20">
        <header className="sticky top-0 z-10 flex items-center justify-between h-16 px-4 md:px-6 bg-card border-b">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h1 className="text-xl font-bold font-headline">Featured Profiles</h1>
            </div>
          </div>
          <div className="flex items-center gap-2">
                ...
                <CardHeader className="p-0 relative">
                  ...
                  />
                   ...
                   <div className="absolute top-2 right-2">
                        <Badge variant="default" className="bg-amber-400 text-black gap-1">
